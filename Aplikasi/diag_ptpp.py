"""Diagnostic: OCR the 3 problematic PTPP files to analyze location detection."""
import sys, os, re
...
files = [
    "26-01-2025_PERAWATAN PERALATAN TELEKOMUNIKASI DI PINTU PERLINTASAN 1 BULANAN_Bogor-Batutulis.pdf",
    "26-01-2025_PERAWATAN PERALATAN TELEKOMUNIKASI DI PINTU PERLINTASAN 1 BULANAN_Bogorpaledang-Batutulis.pdf",
    "26-01-2025_PERAWATAN PERALATAN TELEKOMUNIKASI DI PINTU PERLINTASAN 1 BULANAN_Bogorpaledang.pdf",
]
